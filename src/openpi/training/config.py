...
class DataConfigFactory(abc.ABC):
    ...
    def _load_norm_stats(self, assets_dir: epath.Path, asset_id: str | None) -> dict[str, _transforms.NormStats] | None:
        ...
        try:
            ...
            logging.info(f"Achtung! {data_assets_dir}")
...
@dataclasses.dataclass(frozen=True)
class CustomDroidDataConfig(DataConfigFactory):
    # If provided, will be injected into the input data if the "prompt" key is not present.
    default_prompt: str | None = None
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        repack_transform = _transforms.Group(
            inputs=[
                _transforms.RepackTransform(
                    {
                        "observation/exterior_image_1_right": "external_image",
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_droid_train",
        model=pi0.Pi0Config(action_horizon=10, action_expert_variant="gemma_300m_lora",paligemma_variant="gemma_2b_lora"),
        data=CustomDroidDataConfig(
            repo_id="EAS_IIS/custom_droid_mcap_1",
            assets=AssetsConfig(assets_dir="./assets/pi0_droid_train",asset_id="EAS_IIS/custom_droid_mcap_1"),
        ...
        freeze_filter=pi0.Pi0Config(
             action_expert_variant="gemma_300m_lora",paligemma_variant="gemma_2b_lora"
        ).get_freeze_filter(),
    ...
    TrainConfig(
        name="pi0_droid_train_full_touch_orange_cube",
        model=pi0.Pi0Config(action_horizon=10, action_expert_variant="gemma_300m",paligemma_variant="gemma_2b_lora"),
        data=CustomDroidDataConfig(
            repo_id="EAS_IIS/custom_droid_mcap_1_touch_orange_cube",
            assets=AssetsConfig(assets_dir="./assets/pi0_droid_train",asset_id="EAS_IIS/custom_droid_mcap_1_touch_orange_cube"),
            default_prompt="Dont do stupid shit",
            base_config=DataConfig(
                prompt_from_task=True,
                local_files_only=True
    ...
    TrainConfig(
        name="pi0_droid_train_lora_touch_orange_cube",
        model=pi0.Pi0Config(action_horizon=10, action_expert_variant="gemma_300m_lora",paligemma_variant="gemma_2b_lora"),
        data=CustomDroidDataConfig(
            repo_id="EAS_IIS/custom_droid_mcap_1_touch_orange_cube",
            assets=AssetsConfig(assets_dir="./assets/pi0_droid_train",asset_id="EAS_IIS/custom_droid_mcap_1_touch_orange_cube"),
    ...
    # TrainConfig(
    #     name="pi0_droid_train_fast",
    #     model=pi0_fast.Pi0FASTConfig(action_horizon=10,paligemma_variant="gemma_2b_lora"),
    #     data=CustomDroidDataConfig(
    #         repo_id="EAS_IIS/custom_droid_mcap_1",
    #         assets=AssetsConfig(assets_dir="./assets/pi0_droid_train_fast",asset_id="EAS_IIS/custom_droid_mcap_1"),
    #         default_prompt="Dont do stupid shit",
    #         base_config=DataConfig(
    #             prompt_from_task=True,
    #             local_files_only=True
